...
> Historical product-direction record. It predates the Mirror, current activation flow, and current keymap. For shipped behavior use `product-documentation.md`; for domain truth use `CONTEXT.md` and ADRs.
